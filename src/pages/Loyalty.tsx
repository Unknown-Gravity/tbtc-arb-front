					...
					>
						<Stack gap='15px' maxW='720px'>
							...
							<Text fontSize='15px' fontWeight={300} mt="16px">
								...
								This loyalty program rewards liquidity providers not just for their 
								participation but for their commitment.
							</Text>
							<Text fontSize='15px' fontWeight={300} mb="12px">
								Points are assigned based on your weighted average liquidity across 
								Curve and Uniswap V3 pools on Arbitrum. When the program concludes, the points 
								determine your cut of the treasure. The more liquidity you provide,
								the more treasure you’ll claim.
							</Text>
						</Stack>
					</Flex>
				</Box>
